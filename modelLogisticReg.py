...
def train_logistic_regression_model(X_train, y_train, X_val, y_val, X_test, y_test):
...
def main():
    ...
    train_logistic_regression_model(X_train, y_train, X_val, y_val, X_test, y_test)
